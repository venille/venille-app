...
//               children: [
//                 SubtitleText(text: 'Cycle Length', weight: FontWeight.w400),
...
//               mainAxisAlignment: MainAxisAlignment.spaceBetween,
//               children: [
//                 SubtitleText(text: 'Period Length', weight: FontWeight.w400),
...
//               mainAxisAlignment: MainAxisAlignment.spaceBetween,
//               children: [
//                 SubtitleText(text: 'Luteal Phase', weight: FontWeight.w400),
//                 const SizedBox(height: 6),
//                 DropdownButton<int>(
...
class _CycleOvulationScreenState extends State<CycleOvulationScreen> {
  ...
  void initializeCycleOvulationInfo() {
    if (ServiceRegistry.userRepository.cycleOvulationInfo.value.cycleLength !=
        0) {
      setState(() {
        _selectedCycleLength =
           ServiceRegistry.userRepository.cycleOvulationInfo.value.cycleLength.toInt();
      });
    }
    if (ServiceRegistry.userRepository.cycleOvulationInfo.value.periodLength !=
        0) {
      setState(() {
        _selectedPeriodLength =
           ServiceRegistry.userRepository.cycleOvulationInfo.value.periodLength.toInt();
      });
    }
    if (ServiceRegistry.userRepository.cycleOvulationInfo.value.lutealPhaseLength !=
        0) {
      setState(() {
        _selectedLutealPhaseLength =
           ServiceRegistry.userRepository.cycleOvulationInfo.value.lutealPhaseLength.toInt();
      });
    }
          ...
          children: [
            ...
            Row(
              ...
              children: [
                ...
                const SizedBox(height: AppSizes.vertical_10),
                DropdownButton<int>(
                  value: ServiceRegistry.userRepository.cycleOvulationInfo.value
                              .cycleLength
                              .toInt() !=
                          0
                      ? ServiceRegistry
                          .userRepository.cycleOvulationInfo.value.cycleLength
                          .toInt()
                      : _selectedCycleLength,
                  items: List.generate(
                    21,
              ...
              children: [
                ...
                DropdownButton<int>(
                  value: ServiceRegistry.userRepository.cycleOvulationInfo.value
                          ...
                          0
                      ? ServiceRegistry
                          .userRepository.cycleOvulationInfo.value.periodLength
                          .toInt()
                      : _selectedPeriodLength,
                  items: List.generate(9, (index) {
                    final day = 2 + index;
              ...
              children: [
                ...
                DropdownButton<int>(
                  value: ServiceRegistry.userRepository.cycleOvulationInfo.value
                              ...
                              .toInt() !=
                          0
                      ? ServiceRegistry.userRepository.cycleOvulationInfo.value
                          .lutealPhaseLength
                          .toInt()
                      : _selectedLutealPhaseLength,
                  items: List.generate(7, (index) {
